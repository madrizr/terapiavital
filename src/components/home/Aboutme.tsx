      ...
      <div className="container mx-auto px-6 py-16 md:py-24">
        <div className="grid grid-cols-1 gap-12 md:gap-16 items-center">
          ...
          <div className="md:text-left">
            ...
            <div className="bg-white rounded-[13px] p-[10px] md:p-[20px] border border-black/10 shadow-[1px_1px_5px_rgba(0,0,0,0.1)] w-full">
              <p className="text-gray-600 mb-6 leading-relaxed">
                ...
                sanación. Comenzó sus estudios en la &lsquo;Fundación de escuelas
                Nei Jing&lsquo;, instituto internacional. En la sede de Caracas
